...
export default function BlockCb2() {
    ...
    const fetchBlockAData4 = async () => {
        ...
        try {
            ...
            if (snapshot4.exists()) {
                ...
                console.log('Fetched BlockCB data:', data4);
                setBlockAData4(data4); // Set the fetched data to state
            } else {
                Alert.alert('Error', 'No data found for this report ID.');
            }
        } catch (error) {
            console.error('Error fetching BlockCB data:', error);
            Alert.alert('Error', 'Failed to fetch data of Block B. Please try again.');
        } finally {
            setLoading(false);
        }
    ...
    const validateForm = () => {
        ...
        const fields = [ShiftRemarks, Shiftsignature];
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.formContainer}>
                ...
                <Text style={styles.label}>Verified by: remarks (If any ):</Text>
                <TextInput
                    style={styles.input}
                    value={ShiftRemarks}
                    onChangeText={(text) => setShiftRemarks(text)}
                ...
                <TextInput
                    ...
                    onChangeText={(text) => setShiftsignature(text)}
